...
if SERVER then
    ...
    if ply:KeyDown(IN_WALK) or not careful then
    ply:SetTardisData("vmlocoldisable", true, true) -- MUST be disabled here or else itll affect the EXTERIOR for SOME REASON???
    end

        timer.Simple(0.06, function() -- necessary for the VM light override to update for some reason
