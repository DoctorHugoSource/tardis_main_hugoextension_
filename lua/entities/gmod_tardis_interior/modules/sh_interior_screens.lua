...
ENT:AddHook("CanToggleScreens", "power", function(self)  -- todo: enable screens in low power mode, but cant figure out the texture sets yet
    if self:GetData("lowpowermode",true) then return true end
