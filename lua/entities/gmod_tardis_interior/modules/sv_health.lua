...
-- ENT:AddHook("OnHealthChange", "health", function(self, newhealth, oldhealth) -- gonna replace this with an entirely new impact system more similar to the new exterior impact system
