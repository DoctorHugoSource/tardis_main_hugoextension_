...
T.Interior = {
    ...
    LightOverride = {
        basebrightness = 0.05,
        -- nopowerbrightness = 0.011,  -- i would define it here but i like how the automatic lowpower brightness looks here so ill keep that as like a 'it can work really well' kinda example
    ...
    position = Vector(17, 84, 10)  -- defines the position the transducer cell spawns in, relative to the main interior entity
        ...
        WindowTint = {
        Vortex = Color(60, 30, 150):ToVector()*3, --color for the window tint during vortex travel
        TintMult = 3, --multiplier for window tint brightness
        DoorSpeedMult = 1.5,  -- accounts for different door animation speeds
        DoorSpeedMultClosed = 1,  -- lower values = faster
        ExtTint = Color(60, 30, 150):ToVector()*3,  -- exterior window tint color
        Extambient = Color(60, 30, 150),  -- exterior ambient lighting color
        },
        PhaseData = {
        ...
        TintProxies_Int = {
        [2] = "models/hugoextension/windows/default/windows2_tint.vmt",
        [7] = "models/hugoextension/windows/default/windows2_tint.vmt",
        [8] = "models/hugoextension/windows/default/windows2_tint.vmt",
        [10] = "models/hugoextension/windows/default/windows2_tint.vmt",
        [11] = "models/hugoextension/windows/default/windows2_tint.vmt",
        [12] = "models/hugoextension/windows/default/windows2_tint.vmt",
        },
        TintProxies_Ext = {
        [2] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [6] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [7] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [10] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [11] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [12] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        },
        TintProxies_ExtDoor = {
        [2] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [6] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [7] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [9] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [10] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        [11] = "models/hugoextension/windows/default/windows2_tint_ext.vmt",
        },
...
T.Exterior = {
    ...
    Parts = {
        stephelper = {pos = Vector(18,0,0.4), ang = Angle(0, 0, 0), },  -- forward, side, up
		stephelper2 = {pos = Vector(14,0,3.65), ang = Angle(0, 0, 0), },
    },
}
